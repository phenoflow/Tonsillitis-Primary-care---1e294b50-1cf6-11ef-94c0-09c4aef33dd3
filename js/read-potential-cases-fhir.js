...
(async () => {
  ...
  await fs.writeFile("tonsillitis-primary-care-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("tonsillitis-primary-care-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
